...
- `process_emails.py` -- Process incoming emails (e.g., account activation): `PYTHONPATH=. uv run scripts/process_emails.py`
- `email_hub.py` -- Listen for email commands: `PYTHONPATH=. uv run scripts/email_hub.py`
